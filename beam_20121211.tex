...
%2%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
\frametitle{Les différentes échelles océaniques}
  \begin{tikzpicture}
...
%  \vsapce{1cm}
  \begin{itemize}
    \item \textbf{Traceur}: images SST et Chlorophylle (capteur MODIS, produit L2)
...
%12%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
  \frametitle{Results: Lagrangian trajectories }
  \begin{columns}
...
%8%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
  \frametitle{Comparaison entre le traceur et le FSLE}
\begin{multicols}{2}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
  \frametitle{L'influence de différents paramètre sur la faisabilité de l'inversion}
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item The feasability of the method is confirmed by the inversion of a tracer in a model. 
  \end{itemize}
  \end{block}
