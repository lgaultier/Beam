...
\only<3-4>{
            ...
            \node[color=black] (alti) at (12.0,5.7) {\bf Satellite altimétrique};}
\only<2-4>{
           \draw[fill=green!60, anchor=base,opacity=0.7] (8.6,5) ellipse (1.4 and 1.6);
           \node[color=black] (meso) at (10.3,3.6) {\bf Phénomènes sous-méso et mésoéchelles};}
...
%    \node[color=green, text width=4cm, text centered] (TRA) at (0,2.7) {Sub-mesoscale tracer image};
  ...
  \begin{block}{Approche similiare à une assimilation de donnée}
   Construire d'un problème inverse: trouver le meilleur compromis entre la vitesse provenant de l'altimétrie et les images traceurs, ainsi que l'erreur associée.
  \end{block}}
...
\subsection[Inversion]{Inversion d'image traceur}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
...
%11%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
  \frametitle{Résultats: Correction de la dynamique grâce à la Chlorophylle et l SST}
  ...
  %   \hline
    ...
    & \includegraphics[width=2.72cm]{./pict/satl/aviso_h_020471_min_oc.png} 
   & \includegraphics[width=2.40cm]{./pict/satl/aviso_20471_s_atl2_sa_oc.png}
   & \includegraphics[width=2.72cm]{./pict/satl/fsle_48_stat_reg_20471__sa_bin1_oc.png}
   & \\      
 %\hline
  \end{tabular}
...
\begin{frame}
  ...
  \begin{columns}
    ...
    \begin{column}{0.5\textwidth}
      \begin{figure}
        \includegraphics[width=4.5cm]{./pict/satl/traj_sa_chl_20471_s_atl2.png}\\
...
\end{minipage}
\begin{block}{}
Les traceurs considérés sont la SST et la SSS
\end{block}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\subsection{Construire l'inversion des images}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
  \frametitle{Faisabilité de l'inversion}
Le sous-espace d'erreur\\
L'image traceur idéale => perte d'information lors de la binarisation du gradient
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
