...
\begin{frame}
 ...
 \begin{tikzpicture}
    ...
    \node[pname,text width=2cm] (OBS) at (4,8.98) {Observations};
    \node[pname,text width=2cm] (IM) at (4,5.08) {Image};
    \draw[fleche] (OBS)--(IM);
    \draw[dashed,line width=0.5mm] (5.5,8.18)--(5.5,4.88);
   ...
   \node[pname, text width=12cm] (J) at (09,4.00) {COST FUNCTION: $J(\vec{u})=\|I_{tracer}- I_{FSLE}(\vec{u})\| + background\ term$};
   \draw[fleche] (IMTRA)--(J);
   \draw[fleche] (IMDYN)--(J);
  \end{tikzpicture} \\
...
\begin{minipage}{0.3\textwidth}
\begin{center}
\includegraphics[width=1\linewidth]{./pict/sa_uv-R2BIGvel_0324_0070_mod.png}\\
...
\note{Here are the results of the inversion of the Chlorophyll or the sst image. We can see that our methods enable us to correct the perturbation in the right direction. The eddy is shifted in accordance with the tracer observation. We are far from correcting all the error, 40\% of the error is corrected. But the correction we made improved the assessment of the velocity.}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{frame}
  ...
  \begin{figure}
    \includegraphics[width=0.5\linewidth]{pict/satl/s_atlb2.jpg}
  \end{figure}
  \begin{itemize}
...
\begin{frame}
  ...
  \begin{tabular}{p{0.2em}cccl}
    ...
    & \includegraphics[width=2.75cm]{./pict/satl/aviso_h_020471.png} 
    & \includegraphics[width=2.35cm]{./pict/satl/aviso_20471_s_atl2_oc.png}
    & \includegraphics[width=2.75cm]{./pict/satl/fsle_48_stat_reg_20471__bin0.png}
    & \alt<2>{\includegraphics[width=2.73cm]{./pict/satl/chl2006019.png}} 
      {\includegraphics[width=2.75cm]{./pict/satl/sst_20471_small.png}} \\
  %   \hline
    % \hline
    \rotatebox{90}{\small{CORRECTION}}
    & \alt<2>{\includegraphics[width=2.7cm]{./pict/satl/aviso_h_020471_eof_bin1_oc.png}}
        {\includegraphics[width=2.7cm]{./pict/satl/aviso_h_020471_mean_bin0.png}} 
   & \alt<2>{\includegraphics[width=2.3cm]{./pict/satl/aviso_20471_s_atl2_sa_oc.png}}
        {\includegraphics[width=2.3cm]{./pict/satl/aviso_20471_s_atl2_mean-2.png}} 
   & \alt<2>{\includegraphics[width=2.75cm]{./pict/satl/fsle_48_stat_reg_20471__sa_bin1_oc.png}}
        {\includegraphics[width=2.75cm]{./pict/satl/fsle_48_stat_reg_20471__eof_bin0.png}} 
   & \\      
 %\hline
  \end{tabular}
