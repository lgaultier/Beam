...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \subsection{The different scales in the Ocean}
...
\begin{frame}
  ...
  \begin{tikzpicture}
    ...
    \node[pname,text width=10cm] (OBSTRA) at (20.5,2.08) {MODIS observation of Sea Surface Temperature and/or Chlorophyll};
...
We build images representing the dynamical structures visible in the tracer and in the altimetric data. The image representing the tracer structure is the norm of the gradient of the tracer and the image representing the velocity is the corresponding FSLE
...
%\temporal<n> {before}{at n}{after}
  ...
  \begin{itemize} 
    \item NEMO dynamics coupled with LOBSTER biogeochimics model
    \item Channel domain: $478 \times 500 \times 4$ km ($ 240 \times 252 \times 30$ points de grilles)
...
\begin{center}
\includegraphics[width=1\linewidth]{./pict/sa_uv-R2BIGvel_0324_pert_mod.eps}
\\
...
\begin{minipage}{0.3\textwidth}
\begin{center}
\includegraphics[width=1\linewidth]{./pict/sa_uv-R2BIGvel_0324_0070_mod.eps}
\\
...
\begin{minipage}{0.3\textwidth}
\begin{center}
\includegraphics[width=1\linewidth]{./pict/sa_uv-R2BIGvel_0324_F_mod.eps}
\\
...
\begin{center}
\includegraphics[width=1\linewidth]{./pict/sa_uv-R2BIGsst_0324.eps}
\\
{\small \bf SST}
\end{center}
\end{minipage}
\begin{minipage}{0.34\textwidth}
\begin{center}
\includegraphics[width=1\linewidth]{./pict/sa_uv-R2BIGchl_0324.eps}
\\
...
\note{Here are the results of the inversion of the Chlorophyll or the sst image. We can see that our methods enable us to correct the perturbation in the right direction. The eddy is shifted in accordance with the tracer observation. we are far from correcting all the error, 40\% of the error is corrected. But the xorrection we made improved the assessement of the velocity.}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
It is feasible to invert sub-mesoscale tracer information for the control of dynamic in the ocean at larger scale, in a real context. 
Moreover, the inversion using a model proved that the correction is relevant. 40\% of the error on the perturbed file is corrected. 
We need to carry on studies on the inversion in a model, to improve the method. Therefore, we also plan on working with a realistic configuration of the Salomon Sea. 
