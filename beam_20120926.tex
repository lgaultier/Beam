...
%  \end{columns}
  \only<2>{
  \begin{block}{}
    Joint use of altimetry and high resolution tracer observation to improve the assessment of the dynamics.
  \end{block}} 
\note{
...
\begin{frame}
  ...
  \note{ 
In this study, the altimetric and the tracer image observation are used together to improve the assessment the dynamics at small scales. 
