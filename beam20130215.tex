...
%\frametitle{Strategy}
  ...
  \begin{enumerate}
    ...
    \item Model data: 
    \begin{itemize}
      \item Process model: Assess the error of the estimate (and of the method).
      \item Realistic model: Limits of the method, Required conditions to apply the method
    \end{itemize}
  \end{enumerate}
  \end{block}
\end{frame}
...
\end{tabular}
  ...
  At small scales, non Gaussian information is added using inversion of tracer images \\
  \end{block}
\end{frame}
...
\frametitle{SWOT prospects}
 ...
 \end{block}
  ...
  \begin{block}{}
  \begin{itemize}
    \item Add non Gaussian information using the inversion of image \\
...
\begin{frame}
  ...
  \begin{itemize}
   ...
   \item Limits of the method: investigated with realistic model
  \end{itemize}
  \end{block}
