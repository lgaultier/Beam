...
\begin{frame}
  \begin{columns}
   \column{.01\textwidth}
    ...
    \begin{block}{}
<<<<<<< HEAD
      Submesoscales generated by mesoscale \\
      Can submesoscales information be used to control mesoscales?
=======
      Submesoscales generated by mesoscale
      To what extend can sub-mesoscales control mesoscale
>>>>>>> 88e54b6c8de7481bf9ab595645cfdf881ed441c6
    \end{block}
...
\begin{frame}
  ...
  \begin{figure}
    \includegraphics[width=1.\linewidth]{along_track_tas.png}
    \legende{\small Jason and Envisat tracks, 15 days before and after December 22, 2004,
 Tasmania }
  \end{figure}
<<<<<<< HEAD
  \end{minipage}
  \begin{minipage}{0.5\textwidth}
  \begin{block}
    3 satellites are necessary to capture mesoscale signal \\
    Submesoscales cannot be seen altimetric satellites
  \end{block}
  \end{minipage}
=======
Numerous spectral studies have been made using altimetric data (Xu and Fu 2012, LeTraon \& al, 2009) and enhance the importance of mesoscales in term of energy.  
>>>>>>> 88e54b6c8de7481bf9ab595645cfdf881ed441c6
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{frame}
  ...
  \begin{block}
   Tracer observation and FSLE derived from altimetric velocity have showed many similarities\\
...
% Lyapunov exponents constitute Lagrangian transport barriers between different regions (Lehahn \& al (2007)).
  \begin{block}{Lyapunov Exponent constitute Lagrangian transport barriers between different regions}
     ...
     Advect particles in time (backward) \\
...
%\frametitle{Strategy}
  ...
  \begin{enumerate}
    ...
    \item Model data: 
    \begin{itemize}
      \item Process model: High Resolution coupled physico-biogeochemical model. Inversion of the SST and the Chlorophyll: Assess the error of the estimate (and of the method), study impact of image processing on the estimation of the velocity
      \item Realistic model: High Resolution realistic model of the Solomon Sea. Inversion of the SST and the SSS: Assess the efficiency of the correction on the velocity, the required conditions to apply the method
    \end{itemize}
  \end{enumerate}
  \end{block}
\end{frame}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
\frame{High Resolution coupled physico-biogeochemical model}
...
%Inversion with SST alone, Chl alone 
  ...
  \begin{center}
    \includegraphics[width=1\linewidth]{./pict_nemo/EEL-R2BIGvel_0329.png}\\
    {\small \bf Background velocity}
  \end{center}
  \end{minipage}
  \begin{minipage}{0.3\textwidth}
  \begin{center}
    \alt<2>{\includegraphics[width=1\linewidth]{./pict_nemo/sa_uv-R2BIGvel_0324_0090sst.png}}{\includegraphics[width=1\linewidth]{./pict_nemo/sa_uv-R2BIGvel_0324_0090chl.png}}\\
    {\small \bf Corrected velocity}
  \end{center}
  \end{minipage}
  \begin{minipage}{0.3\textwidth}
  \begin{center}
    \includegraphics[width=1\linewidth]{./pict_nemo/EEL-R2BIGvel_0324.png}\\
    {\small \bf True velocity}
  \end{center}
  \end{minipage}
  \begin{minipage}{0.34\textwidth}
  \begin{center}
    \alt<2>{\includegraphics[width=1\linewidth]{./pict_nemo/sa_uv-R2BIGsst_0324.png}}{\includegraphics[width=1\linewidth]{./pict_nemo/sa_uv-R2BIGchl_0324.png}}\\
    \alt<2>{{\small \bf SST}}{{\small \bf Chlorophyll}}
  \end{center}
  \end{minipage}
  ...
  \begin{block}{}
    $\simeq$ \alt<2>{45\%}{20\%} of the error on the background velocity is corrected using the \alt<2>{SST}{Chlorophyll} as a tracer. \\
    \alt<2>{Each tracer add part of the information}{}
  \end{block}
  \end{minipage}
...
%Inversion with SST and Chl,  
  ...
  \begin{minipage}{0.3\textwidth}
  \begin{center}
    \includegraphics[width=1\linewidth]{./pict_nemo/sa_uv-R2BIGvel_0324_0090sstetchl.png}\\
    {\small \bf Corrected velocity}
  \end{center}
  \end{minipage}
  \begin{minipage}{0.3\textwidth}
...
%Inversion with bidouille SST+Chl 
  ...
  \begin{minipage}{0.3\textwidth}
  \begin{center}
    \includegraphics[width=1\linewidth]{./pict_nemo/sa_uv-R2BIGvel_0324_0090struct.png}\\
    {\small \bf Corrected velocity}
  \end{center}
  \end{minipage}
  \begin{minipage}{0.3\textwidth}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
%Add information using SST aand Chlorophylle and Structure
 \begin{minipage}{0.49\textwidth}
  \begin{center}
...
\begin{block}{Improvement needed for the image processing}
\begin{itemize}
...
\begin{frame}
The correction we made on the velocity is consistent and the inversion method showed good results on model, can be trusted. 
...
\frametitle{Data image assimilation}
  ...
  \end{itemize}
  \begin{tikzpicture}
    \node[anchor=west,inner sep=0] (AVISO) at (-6,0){\includegraphics[width=6.5cm]{}}; % pict AVISO Solomon
    \node[anchor= west,inner sep=0] (SST) at (-6,-6){\includegraphics[width=2.5cm]{}}; %pict SST Solomon
    %\node pict model Solomon
    %\node pict model Solomon
    \draw[=>,line width=0.25mm] (-2.6,0.6)--(1.55,1.25); %from AVISO to model
    \draw[=>,line width=0.25mm] (-2.6,-0.65)--(1.55,-1.2); %from SST to model
  \end{tikzpicture}
...
\end{tabular}
  ...
  At large scale, altimetry can control dynamics in the ocean \\
  At small scales, control complex structures using tracer images \\
  \end{block}
\end{frame}
...
\frametitle{SWOT prospects}
 ...
 \end{block}
  ...
  \begin{itemize}
    ...
    \item Enrichir le signal par rapport à de l'assimilation point par point %%%%%
...
\begin{frame}
  ...
  \begin{block}{}
  \begin{itemize}
     \item Investigation of the necessary condition to apply this method, is this universel? does it require specific conditions? 
