...
\author[JPL Seminar]{Lucile Gaultier, Jacques Verron, Pierre Brasseur, Jean-Michel Brankart}
\date{\textit{April 16, 2013}}
...
\begin{frame}
  ...
  \end{block}
  \begin{minipage}{0.49\textwidth}
    \includegraphics[width=0.7\linewidth]{./pict/sstcalifornia.png}\\
    {\small SST from MODIS sensor \\ (25-27 April 2011)}
  \end{minipage}
  \begin{minipage}{0.49\textwidth}
    \includegraphics[width=0.7\linewidth]{./pict/chlcalifornia.png}\\
   {\small Chlorophyll from MODIS sensor \\ (25-27 April 2011)}
  \end{minipage}
  \begin{block}{}
...
\begin{frame}
  ...
  \begin{block}{}
Lagrangian tool that gives a measure of ocean stirring \\
...
% Lyapunov exponents constitute Lagrangian transport barriers between different regions (Lehahn \& al (2007)).
  \begin{block}{Lyapunov Exponent constitute Lagrangian transport barriers between different regions}
      FSLE measures the separation rate of particules \\
      Tracer cannot cross lines of maximum of FSLE 
...
%What is the FSLE
  \begin{columns}
    \begin{column}{0.5\textwidth}
      \begin{figure}%[!htbp]
        \alt<2>{\includegraphics[width=4.1cm]{pict/pfsle20814.png}}{\includegraphics[width=4.5cm]{pict/fsle_24_stat_reg_20814_s_atl.png}}\\
%\alt<2>{\includegraphics[width=4.5cm]{pict/med/pfsle_48_stat_reg_19904_med.jpg}}
%{\includegraphics[width=4.5cm]{pict/med/fsle_48_stat_reg_19904_med.jpg}} \\
        \legende{FSLE, South Atlantic region, \\December 27, 2006}
%\legende{FSLE, Mediterranean area}
      \end{figure}
    \end{column}
    \begin{column}{0.5\textwidth}
      \begin{figure}
%\alt<2>{\includegraphics[width=4.5cm]{pict/med/binsst_bin1.png}}
%{\includegraphics[width=4.5cm]{pict/med/A2004184123500_L2_LAC_SST.jpg}} \\
%\legende{Tracer (SST), Mediterranean area}
        \alt<2>{\includegraphics[width=4.1cm]{pict/sst20814.png}}{\includegraphics[width=4.5cm]{pict/A2006360165000_L2_LAC_SST.png}}\\
...
%Annual cycle
  ...
  \end{minipage}
  \begin{minipage}{0.49\textwidth}
    \includegraphics[width=6.5cm]{./pict_nemo/Interquantile_SST_A1.png}\\
    \includegraphics[width=6.5cm]{./pict_nemo/Interquantile_SSS_A1.png}\\
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
%\frametitle{$J(\vec{u})=\alpha\|\mathcal{I}_{FSLE}(\vec{u})- \mathcal{I}_{SST}\| + (1-\alpha)\|\mathcal{I}_{FSLE}(\vec{u})- \mathcal{I}_{SSS}\| +bg $}
