...
\title{On the use of sub-mesoscale tracer information \hspace{4cm} and mesoscale altimetric field \hspace{6cm} for the control of ocean circulations.}
\subtitle{\vspace{1.5em} \textbf{A Data Assimilation strategy}}
\author[OSM ]{Lucile Gaultier, Jacques Verron, Pierre Brasseur, Jean-Michel Brankart}
\date{\textit{February 22, 2012}}
...
\section{Context and objectives}
  \subsection{Sub-mesoscales}

%2%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
  \frametitle{Sub-mesoscales }
  \begin{columns}
   \column{.01\textwidth}
    \column{.50\textwidth}
    ...
    \begin{block}{}
      ...
      \end{itemize}
    \end{block}
    \begin{block}{Generation of sub-mesoscales}
      \begin{itemize}
        \item Frontogenesis.
        \item Unforced instabilities such as ageostrophic baroclinic instability.
        \item Forced motions such as flows affected by buoyancy fluxes.  
      \end{itemize}
    \end{block}

    \column{.49\textwidth}
    \includegraphics[width=0.9\linewidth]{submeso.png}\\
  ...
  \begin{block}{Importance of sub-mesoscales }
    ...
    %\end{itemize}
     \small{(Capet \& al, 2008, Thomas \& al, 2008, Klein \& al, 2008, Ferrari \& al, 2008)  %Marchiasiello AJOUTER DATE FERRARI
           } 
  \end{block}
\note{
Our goal is to represent sub-mesoscale structures in the dynamic field. 
%The main ingredient of these talk is the observation of sub-mesoscales. 
I am not going to give you a lecture on the theory of the sub-mesoscales since we have already heard about it and you probably know more about it than I do.
The main concern here is the representation of sub-mesoscale structures, that is to say 1 km length filament. 
Indeed, these small structures have a huge impact on larger scale. 
More over we observe these structures in tracer such as the Chlorophyll as you can see on the picture from a model. 
...
\subsection[Inversion]{Inversion of sub-mesoscale information}
