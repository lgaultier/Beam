...
%Add information using SST aand Chlorophylle and Structure
 \begin{minipage}{0.49\textwidth}
  ...
  \begin{center}
    ...
    {\small \bf Error on the velocity  as a function of iterations (semi-log)}
  \end{center}
  \end{minipage}
...
\begin{itemize}
  ...
  \item Merging SST and Chlorophyll enables us to detect structure from the dynamic only
\end{itemize}
\end{block}
\end{frame} 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
&
  $\begin{pmatrix}
    Large\ scale \\ 
    Large\ scale \\ 
    Small\ scales, non linear operator
  \end{pmatrix} $
\\
\end{tabular}
