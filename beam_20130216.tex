...
%\frametitle{Strategy}
  ...
  \begin{enumerate}
    ...
    \begin{itemize}
      ...
      \item Realistic model: Limits of the method, Recquired conditions to apply the method
    \end{itemize}
  \end{enumerate}
  \end{block}
\end{frame}
...
%Inversion with SST alone, Chl alone 
  ...
  \begin{center}
    \alt<2>{\includegraphics[width=1\linewidth]{./pict/sa_uv-R2BIGsst_0324.png}}{\includegraphics[width=1\linewidth]{./pict/sa_uv-R2BIGchl_0324.png}}\\
  ...
  \begin{block}{}
    $\simeq$ \alt<2>{}{20\%} of the error on the background velocity is corrected using the \alt<2>{SST}{Chlorophyll} as a tracer. \\
...
%Inversion with bidouille SST+Chl 
  ...
  \begin{minipage}{0.34\textwidth}
  \begin{center}
    %\includegraphics[width=1\linewidth]{./pict/sa_uv-R2BIGsstchl_0324.png}\\
  ...
  \begin{minipage}{0.6\textwidth}
  \begin{block}{}
    $\simeq$ 45\% of the error on the background velocity is corrected using the 'structure' image. \\
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\subsection{Part of the information extracted from the image}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
...
\begin{block}{}
\begin{itemize}
  \item Dynamic : NEMO-OPA code
  \item Horizontal resolution : $\frac{1}{36}^o$
  \item Vertical resolution : 46 niveaux
...
%Annual cycle
  ...
  \begin{minipage}{0.49\textwidth}
    ...
    \legende{First quantile et Interquantile of the angles spatial distribution}
  \end{minipage}
  \begin{block}{}
    Sesonal cyle of the tracer-FSLE similarity
...
%Feasability of the inversion 
  ...
  \begin{block}{Sub-space of error}
    ...
    \
    {\centering \ding{226} 50 data from the modelxe preceeding the chosen study date.}
  \end{block}
  \begin{block}{Inversion parameters}
  \begin{itemize}
    \item Sub-space of error: EOF analyses on the variation of the model between 5 days
